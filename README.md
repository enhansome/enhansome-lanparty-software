...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,339 | 🐛 792 | 🌐 JavaScript | 📅 2026-08-19 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
