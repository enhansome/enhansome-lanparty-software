...
* [LANager](https://github.com/zeropingheroes/lanager) ⭐ 133 | 🐛 3 | 🌐 PHP | 📅 2026-09-20 – "LAN party management web application"
* [Lan2Play's Eventula Event Manager](https://github.com/Lan2Play/eventula-manager) ⭐ 34 | 🐛 158 | 🌐 PHP | 📅 2026-09-25 – Event Ticket & Management System with (automated) Tournament support and lots of features
...
* [srcds\_exporter (golang)](https://github.com/galexrt/srcds_exporter) ⭐ 32 | 🐛 2 | 🌐 Go | 📅 2026-09-01 – A stats exporter for prometheus written in Go and tested with Garry's Mod.
...
* [steam-lancache-prefill](https://github.com/tpill90/steam-lancache-prefill) ⭐ 465 | 🐛 17 | 🌐 C# | 📅 2026-08-25 – A self-contained, portable alternative to lancache-autofill with more features for steam games
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 38 | 🐛 6 | 🌐 C# | 📅 2026-09-26 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,844 | 🐛 822 | 🌐 JavaScript | 📅 2026-09-26 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
...
* [reboot-lan](https://github.com/Fohdeesha/reboot-lan) ⭐ 14 | 🐛 0 | 🌐 HTML | 📅 2019-12-07 – "lanning + Infra for reBOOT LAN Party"
...
* [Infoscreen4](https://github.com/reaby/infoscreen4) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - Create and publish content to multiple screens from one place
