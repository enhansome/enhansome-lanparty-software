...
* [Lan2Play's Eventula Event Manager](https://github.com/Lan2Play/eventula-manager) ⭐ 34 | 🐛 158 | 🌐 PHP | 📅 2026-08-20 – Event Ticket & Management System with (automated) Tournament support and lots of features
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 33 | 🐛 4 | 🌐 C# | 📅 2026-08-21 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,432 | 🐛 791 | 🌐 JavaScript | 📅 2026-08-21 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
