...
* [LANager](https://github.com/zeropingheroes/lanager) ⭐ 132 | 🐛 3 | 🌐 PHP | 📅 2026-08-16 – "LAN party management web application"
...
* [srcds\_exporter (golang)](https://github.com/galexrt/srcds_exporter) ⭐ 31 | 🐛 4 | 🌐 Go | 📅 2026-08-17 – A stats exporter for prometheus written in Go and tested with Garry's Mod.
...
* [steam-lancache-prefill](https://github.com/tpill90/steam-lancache-prefill) ⭐ 449 | 🐛 15 | 🌐 C# | 📅 2026-08-02 – A self-contained, portable alternative to lancache-autofill with more features for steam games
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 33 | 🐛 5 | 🌐 C# | 📅 2026-08-19 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,332 | 🐛 791 | 🌐 JavaScript | 📅 2026-08-19 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
