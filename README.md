...
* [steam-lancache-prefill](https://github.com/tpill90/steam-lancache-prefill) ⭐ 464 | 🐛 17 | 🌐 C# | 📅 2026-08-25 – A self-contained, portable alternative to lancache-autofill with more features for steam games
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 38 | 🐛 6 | 🌐 C# | 📅 2026-09-24 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,814 | 🐛 822 | 🌐 JavaScript | 📅 2026-09-25 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
...
* [Infoscreen4](https://github.com/reaby/infoscreen4) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - Create and publish content to multiple screens from one place
