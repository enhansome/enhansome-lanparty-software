...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 90,240 | 🐛 792 | 🌐 JavaScript | 📅 2026-08-17 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
