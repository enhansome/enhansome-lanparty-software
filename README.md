...
* [LANager](https://github.com/zeropingheroes/lanager) ⭐ 133 | 🐛 3 | 🌐 PHP | 📅 2026-09-13 – "LAN party management web application"
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 37 | 🐛 6 | 🌐 C# | 📅 2026-09-15 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,559 | 🐛 810 | 🌐 JavaScript | 📅 2026-09-19 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
