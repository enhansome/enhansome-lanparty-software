...
* [LANager](https://github.com/zeropingheroes/lanager) ⭐ 132 | 🐛 3 | 🌐 PHP | 📅 2026-09-08 – "LAN party management web application"
...
* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,210 | 🐛 805 | 🌐 JavaScript | 📅 2026-09-10 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
