...
* [LANager](https://github.com/zeropingheroes/lanager) ⭐ 132 | 🐛 3 | 🌐 PHP | 📅 2026-09-06 – "LAN party management web application"
* [Lan2Play's Eventula Event Manager](https://github.com/Lan2Play/eventula-manager) ⭐ 34 | 🐛 158 | 🌐 PHP | 📅 2026-09-07 – Event Ticket & Management System with (automated) Tournament support and lots of features
...
* [srcds\_exporter (golang)](https://github.com/galexrt/srcds_exporter) ⭐ 31 | 🐛 2 | 🌐 Go | 📅 2026-09-01 – A stats exporter for prometheus written in Go and tested with Garry's Mod.
...
* [steam-lancache-prefill](https://github.com/tpill90/steam-lancache-prefill) ⭐ 461 | 🐛 15 | 🌐 C# | 📅 2026-08-25 – A self-contained, portable alternative to lancache-autofill with more features for steam games
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 34 | 🐛 5 | 🌐 C# | 📅 2026-09-08 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,127 | 🐛 800 | 🌐 JavaScript | 📅 2026-09-08 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
