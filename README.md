...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 34 | 🐛 5 | 🌐 C# | 📅 2026-09-06 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
* [LanCache.net](https://lancache.net/)

### Monitoring

* [Uptime-Kuma](https://github.com/louislam/uptime-kuma) ⭐ 91,081 | 🐛 799 | 🌐 JavaScript | 📅 2026-09-07 - Easy to host monitoring solution with a variety of checks from simple pings over TCP checks to gameserver queries. Native installation and Docker deployment solution are available.
