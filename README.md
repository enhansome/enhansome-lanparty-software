...
* [Lan2Play's Eventula Event Manager](https://github.com/Lan2Play/eventula-manager) ⭐ 34 | 🐛 158 | 🌐 PHP | 📅 2026-08-11 – Event Ticket & Management System with (automated) Tournament support and lots of features
...
* [srcds\_exporter (golang)](https://github.com/galexrt/srcds_exporter) ⭐ 31 | 🐛 2 | 🌐 Go | 📅 2026-07-30 – A stats exporter for prometheus written in Go and tested with Garry's Mod.
...
* [LANCache Manager](https://github.com/regix1/lancache-manager) ⭐ 33 | 🐛 5 | 🌐 C# | 📅 2026-08-13 - LANCache Manager is a simple web UI for monitoring and managing your LANCache. You can watch downloads in real time, see which games are cached, measure bandwidth savings, and prefill the cache with Steam and Epic games before LAN parties.
